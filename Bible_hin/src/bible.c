...
gl_longpressed_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	elm_ctxpopup_item_append(verse_popup, "कविता साझा करें", NULL, _share_verse_cb, verse_item);
	elm_ctxpopup_item_append(verse_popup, "कविता कापी करें", NULL, _copy_verse_cb, verse_item);
